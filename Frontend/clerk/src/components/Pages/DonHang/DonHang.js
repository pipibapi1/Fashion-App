  ...
  render() {
    ...
    const TblHead = (props) => {
      const handleSortRequest = (cellId) => {
        const isAsc =
          this.state.orderBy === cellId && this.state.order === "asc";
        if (isAsc) {
          this.setState({
            order: "desc",
          });
          ...
          <TableRow>
            {headCells.map((headCell) => (
              <TableCell
                key={headCell.id}
                sortDirection={
                  this.state.orderBy === headCell.id ? this.state.order : false
                }
              >
            ...
            <div label="Chờ Xác Nhận">
              <Paper>
                <TblContainer>
                  <TblHead />
                  <TableBody>
                    {recordsAfterPagingAndSorting(this.state.cxn).map(
                      (item) => (
                        <TableRow key={item.id}>
                          <TableCell>{item.id}</TableCell>
                          <TableCell>{item.date}</TableCell>
            ...
            <div label="Đang Giao">
              <Paper>
                <TblContainer>
                  <TblHead />
                  <TableBody>
                    {recordsAfterPagingAndSorting(this.state.dggiao).map(
                      (item) => (
                        <TableRow key={item.id}>
                          <TableCell>{item.id}</TableCell>
                          <TableCell>{item.date}</TableCell>
            ...
            <div label="Đã Giao">
              <Paper>
                <TblContainer>
                  <TblHead />
                  <TableBody>
                    {recordsAfterPagingAndSorting(this.state.dgiao).map(
                      (item) => (
                        <TableRow key={item.id}>
                          <TableCell>{item.id}</TableCell>
                          <TableCell>{item.date}</TableCell>
